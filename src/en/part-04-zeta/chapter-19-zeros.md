...
- **Non-trivial zeros**: all remaining zeros. They all lie within the critical strip $0 < \operatorname{Re}(s) < 1$. Chapter 18 explained why they cannot lie outside it.

The Riemann Hypothesis is precisely about the location of the non-trivial zeros: **all non-trivial zeros lie on the critical line $\operatorname{Re}(s) = 1/2$**.
...
- If $\rho$ is a zero, $1 - \rho$ is also a zero (reflection about $\operatorname{Re} = 1/2$)
