...
- Ivić, A. (1985). *The Riemann Zeta-Function: Theory and Applications.* Dover.
- Karatsuba, A. A. & Voronin, S. M. (1992). *The Riemann Zeta-Function.* De Gruyter.
- Patterson, S. J. (1988). *An Introduction to the Theory of the Riemann Zeta-Function.* Cambridge University Press.

## Historical Studies

- Laugwitz, D. (1999). *Bernhard Riemann 1826–1866: Turning Points in the Conception of Mathematics.* Birkhäuser.
- Dedekind, R. (1876). "Bernhard Riemann's Lebenslauf." In *Bernhard Riemann's Gesammelte Mathematische Werke.*
- Klein, F. (1926). *Vorlesungen über die Entwicklung der Mathematik im 19. Jahrhundert.* Springer.
- Goldstein, C., Schappacher, N., & Schwermer, J. (Eds.) (2007). *The Shaping of Arithmetic after C.F. Gauss's Disquisitiones Arithmeticae.* Springer.
...
- Sabbagh, K. (2002). *The Riemann Hypothesis: The Greatest Unsolved Problem in Mathematics.* Farrar, Straus and Giroux.
- Borwein, P., Choi, S., Rooney, B., & Weirathmueller, A. (Eds.) (2008). *The Riemann Hypothesis: A Resource for the Afficionado and Virtuoso Alike.* Springer.
- Conrey, J. B. (2003). "The Riemann Hypothesis." *Notices of the AMS,* 50(3), 341–353.
- Sarnak, P. (2005). "Problems of the Millennium: The Riemann Hypothesis." In *The Millennium Prize Problems.* Clay Mathematics Institute.
